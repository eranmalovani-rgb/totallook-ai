...
import {
  ...
  ExternalLink, Upload, Users, BookOpen, Eye, RefreshCw, Recycle, Wand2, Trash2, Pencil, Send, Loader2, Instagram
} from "lucide-react";
                    ...
                    <AccordionContent className="px-4">
                      <div className="space-y-4 pb-2">
                        {analysis.scores.map((s, i) => (
                          <ScoreBar key={i} label={s.category} score={s.score} explanation={s.explanation} recommendation={s.recommendation} lang={lang} density="regular" />
                        ))}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
