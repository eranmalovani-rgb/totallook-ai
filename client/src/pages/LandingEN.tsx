          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="text-center md:text-start">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#FF2E9F]/20 bg-[#FF2E9F]/5 mb-6">
                ...
                <span className="text-xs text-[#FF2E9F]/80 font-medium tracking-wide">AI Personal Stylist</span>
              </div>

              {/* Version B: Aggressive Converting */}
        ...
        <section className="py-16 md:py-24 px-4">
          <div className="container max-w-4xl mx-auto">
            <div className="text-center mb-12 md:mb-16">
              <p className="text-xs text-[#FF2E9F]/60 tracking-[0.2em] uppercase font-medium mb-4">How it works</p>
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              {[
                ...
                >
                  <div className="text-5xl md:text-6xl font-bold text-[#FF2E9F]/10 absolute top-4 left-4 pointer-events-none">{step.num}</div>
      ...
      <AnimatedSection>
        <section className="py-16 md:py-24 px-4 relative">
          ...
          <div className="container max-w-5xl mx-auto relative z-10">
            <div className="text-center mb-12 md:mb-16">
              <p className="text-xs text-[#FF2E9F]/60 tracking-[0.2em] uppercase font-medium mb-4">What you get</p>
            ...
            <div className="max-w-lg mx-auto rounded-2xl border border-[#FF2E9F]/15 bg-gradient-to-b from-[#FF2E9F]/[0.04] to-background/80 backdrop-blur-sm overflow-hidden shadow-xl shadow-[#FF2E9F]/5">
              <div className="p-6 text-center border-b border-[#FF2E9F]/10">
                ...
                <p className="text-sm text-[#FF2E9F]/60 font-medium">Your look score</p>
              </div>
        ...
        <section className="py-16 md:py-24 px-4">
          <div className="container max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <p className="text-xs text-[#FF2E9F]/60 tracking-[0.2em] uppercase font-medium mb-4">What people say</p>
              <h2 className="text-3xl md:text-4xl font-bold">They're already upgrading</h2>
            </div>

            <div className="grid sm:grid-cols-2 gap-4">
              {testimonials.map((item, i) => (
                <div key={i} className="p-5 rounded-2xl border border-[#FF2E9F]/10 bg-gradient-to-br from-[#FF2E9F]/[0.03] to-transparent hover:border-[#FF2E9F]/20 transition-all duration-300">
      ...
      <section className="py-16 md:py-20 px-4 relative overflow-hidden">
        ...
        <div className="container max-w-3xl mx-auto text-center relative z-10">
          <p className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
            ...
            <span className="text-[#FF2E9F]/60">You're still guessing.</span>
          </p>
      ...
      <section className="py-20 md:py-28 px-4 relative">
        ...
        <div className="container max-w-3xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6">
            ...
            <span className="text-[#FF2E9F]">Takes 5 seconds.</span>
          </h2>
