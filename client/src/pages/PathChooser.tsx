    ...
    <div className="min-h-[100dvh] bg-background text-foreground flex flex-col" dir={dir}>
      ...
      <div className="flex items-center justify-between px-6 pt-6 pb-2">
        <span className="text-xl font-bold tracking-tight">
          <span className="text-[#FF2E9F]">TotalLook</span>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pb-12">
        {/* Ambient glow */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#FF2E9F]/5 rounded-full blur-[150px] pointer-events-none" />

        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#FF2E9F]/20 bg-[#FF2E9F]/5 mb-8 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 w-full max-w-2xl relative z-10">
          ...
          <div
            className="group relative rounded-2xl border-2 border-[#FF2E9F]/30 bg-gradient-to-b from-[#FF2E9F]/[0.08] to-[#7B2EFF]/[0.02] hover:border-[#FF2E9F]/50 hover:from-[#FF2E9F]/[0.12] transition-all duration-300 p-6 sm:p-8 text-center cursor-pointer overflow-hidden"
          >
            {/* Recommended badge */}
            <div className="absolute top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-[#FF2E9F]/20 border border-[#FF2E9F]/30">
              <span className="text-[10px] text-[#FF2E9F] font-bold tracking-wider uppercase">
                {isHe ? "פופולרי" : "Popular"}
              </span>
            </div>

            {/* Icon */}
            <div className="w-16 h-16 mx-auto mb-5 mt-4 rounded-2xl bg-[#FF2E9F]/15 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
              <Zap className="w-8 h-8 text-[#FF2E9F]" />
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#FF2E9F] to-[#7B2EFF] text-black font-bold text-sm group-hover:from-[#FF2E9F] group-hover:to-[#7B2EFF] transition-all duration-300 shadow-[0_0_20px_rgba(245,158,11,0.2)] group-hover:shadow-[0_0_30px_rgba(245,158,11,0.4)]"
            >
              {isHe ? "יאללה!" : "Let's go!"}
          ...
          <Link
            ...
            className="group relative rounded-2xl border border-foreground/10 bg-gradient-to-b from-foreground/[0.03] to-transparent hover:border-[#FF2E9F]/30 hover:from-[#FF2E9F]/[0.05] transition-all duration-300 p-6 sm:p-8 text-center cursor-pointer"
          >
            {/* Icon */}
            <div className="w-16 h-16 mx-auto mb-5 mt-4 rounded-2xl bg-foreground/5 group-hover:bg-[#FF2E9F]/10 flex items-center justify-center group-hover:scale-110 transition-all duration-300">
              <Target className="w-8 h-8 text-foreground/40 group-hover:text-[#FF2E9F] transition-colors" />
            </div>
            ...
            {/* CTA */}
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-foreground/10 group-hover:border-[#FF2E9F]/30 text-foreground/70 group-hover:text-[#FF2E9F] font-bold text-sm transition-all duration-300">
